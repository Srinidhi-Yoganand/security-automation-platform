...
public class OrderController {
     ...
     * - Alice can access /api/companies/B/orders/1 even though Order 1 doesn't belong to Company B
     * - The isOrderOwner check only verifies Alice owns Order 1, not the company context
     */
