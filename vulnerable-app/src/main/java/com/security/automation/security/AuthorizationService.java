...
public class AuthorizationService {
     ...
     * not if the userId matches the current user. This is a simple IDOR vulnerability.
     */
     ...
     * but it does NOT validate that the order belongs to the company specified in the URL.
